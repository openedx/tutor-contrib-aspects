...
hooks.Filters.ENV_PATCHES.add_item(
    (
        ...
        """
RUN --mount=type=cache,target=/root/.npm,sharing=shared echo "installing custom slots" && npm install --legacy-peer-deps open-craft/frontend-plugin-aspects#pull/2/head && echo "done"
""",
    )
)
########################################
