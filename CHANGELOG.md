...
## v1.4.0-saraburns1-patch-1.0 - 2025-03-24

### [1.4.0-saraburns1-patch-1.0](https://github.com/openedx/tutor-contrib-aspects/compare/v1.3.2...v1.4.0-saraburns1-patch-1.0) (2025-03-24)

#### ⚠ BREAKING CHANGES

* Remove python < 3.11 references and Tutor < 18
* use new dbt models and rename datasets to adhere to dim/fact convention
* use angular commit to force major update
...
* use angular commit to force major update ([7a58ccc](https://github.com/openedx/tutor-contrib-aspects/commit/7a58ccce1674423cae7051952fedbdbfc8fc9d43))
