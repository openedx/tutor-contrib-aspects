...
### Features
* feat: New action for manual version release ([cf9f00d](https://github.com/tutor-contrib-aspects/commit/cf9f00ddf28dce96be0719eb1d24ddd2321fef73))
...
* feat: new version bump action ([ab0db2d](https://github.com/tutor-contrib-aspects/commit/ab0db2dbc2120d6875851871980821f02e8331da))
* feat: new version bump action ([9a5ffcf](https://github.com/tutor-contrib-aspects/commit/9a5ffcf8df4c8210ce01fcc958a9e46616e43453))
* feat!: upgrade to paragon23 ([c412426](https://github.com/tutor-contrib-aspects/commit/c412426b8ccc2f2d1a28b53dd7ef288f3902b7fb))
...
* chore: Upgrade Python requirements ([de4f22b](https://github.com/tutor-contrib-aspects/commit/de4f22bafa70bbbfa9ebb31cd9965909472f6b70))
* chore(deps): bump docker/login-action from 4.1.0 to 4.2.0 ([ce83e6b](https://github.com/tutor-contrib-aspects/commit/ce83e6ba135a569f1b247e8b2548e61241e664d5))
* chore(deps): bump docker/setup-buildx-action from 4.0.0 to 4.1.0 ([287498c](https://github.com/tutor-contrib-aspects/commit/287498cbbcf52b834d487af68f57b922d83e91f6))
* chore: Upgrade Python requirements ([04ece48](https://github.com/tutor-contrib-aspects/commit/04ece48c418e7a42a5628004d268865281f2392a))
...
* chore: preparing release 3.0.0 ([ef66203](https://github.com/tutor-contrib-aspects/commit/ef66203fc57c1e597ba30fb18607a4f56171642a))
...
* chore(deps): bump wheel from 0.45.1 to 0.46.2 in /requirements ([e834a14](https://github.com/tutor-contrib-aspects/commit/e834a14349863cdba7435db1b4889d4e994bce1a))
* chore: remove unneeded pod-autoscaling ([e5d5a52](https://github.com/tutor-contrib-aspects/commit/e5d5a52fd3f952262f6e18a318618b4381501d3e))
* chore: update frontend plugin version ([db043f3](https://github.com/tutor-contrib-aspects/commit/db043f3f9f42d1377e62a07782da48ae60567853))
* chore: update plugin version ([e4f3424](https://github.com/tutor-contrib-aspects/commit/e4f34245db24b96b821ce1304bcf55925cdcb359))
* chore(deps): bump pyasn1 from 0.6.1 to 0.6.2 in /requirements ([844b3c2](https://github.com/tutor-contrib-aspects/commit/844b3c27a0a49a1b4fab83a4919f2789ec1c94ea))
* chore: Upgrade Python requirements ([330f417](https://github.com/tutor-contrib-aspects/commit/330f417c87ede378a4f0500329f6b1c7ad671f66))
* chore: Upgrade Python requirements ([9d4d9bf](https://github.com/tutor-contrib-aspects/commit/9d4d9bfef3afd2cf1e69c5dc7bfc3e9a4b4e7b71))
* chore: Upgrade Python requirements ([dee79a3](https://github.com/tutor-contrib-aspects/commit/dee79a3170c0c6fb1ebd2e772cf6af989bbf8c1b))
* chore(deps): bump peter-evans/create-pull-request from 7 to 8 ([d68a875](https://github.com/tutor-contrib-aspects/commit/d68a87559ef2b6e62dcb77862f3f7928a644f4f9))
* chore: Upgrade Python requirements ([fad2562](https://github.com/tutor-contrib-aspects/commit/fad2562a3ea0a80bd51d3191a88b296a8160d396))

### Miscellaneous Updates
* Merge pull request from openedx/repo-tools/upgrade-python-requirements-0b87d54 ([16e9d11](https://github.com/tutor-contrib-aspects/commit/16e9d1138aa511188354dffc548be270fdbcebdd))
* Merge pull request from openedx/dependabot/github_actions/docker/setup-buildx-action-4.1.0 ([0f64925](https://github.com/tutor-contrib-aspects/commit/0f649257cbc863ed9422998ef45ec8920b2b0b3c))
* Merge pull request from openedx/dependabot/github_actions/docker/login-action-4.2.0 ([60bf5b3](https://github.com/tutor-contrib-aspects/commit/60bf5b3ac939c4d202f206962024c865a357f46b))
...
* Merge pull request from openedx/bot/v3.0.0 ([58d0997](https://github.com/tutor-contrib-aspects/commit/58d0997801dfb9204b93f4baba177bee6756019c))
* Merge pull request from saraburns1/new_version_bump_action ([f6093e9](https://github.com/tutor-contrib-aspects/commit/f6093e9b840fad9343fa7300bf152474369b9857))
* Merge pull request from openedx/dependabot/pip/requirements/wheel-0.46.2 ([f9ca21e](https://github.com/tutor-contrib-aspects/commit/f9ca21e5674abec09b22f644205d0f0f69e29b21))
* Merge pull request from saraburns1/upgrade_platform_plugin ([5c85efd](https://github.com/tutor-contrib-aspects/commit/5c85efdae8470f9181603b4c1c1d5639e4ff4cf1))
* Merge pull request from openedx/dependabot/pip/requirements/pyasn1-0.6.2 ([6e15d4f](https://github.com/tutor-contrib-aspects/commit/6e15d4f133fc5f56d4819dbb38b176289432324e))
* Merge pull request from openedx/repo-tools/upgrade-python-requirements-f1a5630 ([ba6e6d0](https://github.com/tutor-contrib-aspects/commit/ba6e6d09c104325d36705a9f3cb52400f17d2f40))
* Merge pull request from openedx/repo-tools/upgrade-python-requirements-73ab76e ([f1a5630](https://github.com/tutor-contrib-aspects/commit/f1a5630137d6ecd7093792f84203bb332afa4f95))
* Merge pull request from openedx/repo-tools/upgrade-python-requirements-f7cc701 ([73ab76e](https://github.com/tutor-contrib-aspects/commit/73ab76ea61d2aa081bd37e954fa473c3f6234688))
* Merge pull request from openedx/repo-tools/upgrade-python-requirements-42ef238 ([f7cc701](https://github.com/tutor-contrib-aspects/commit/f7cc701ad688c5fb1e6d247e173532922e0a4b9d))
* Merge pull request from openedx/dependabot/github_actions/peter-evans/create-pull-request-8 ([51b8a77](https://github.com/tutor-contrib-aspects/commit/51b8a779f7a7738227ad707a3b04734782db4383))
